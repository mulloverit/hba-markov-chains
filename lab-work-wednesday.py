...
def make_text(chains):
    ...
    random_value_of_random_key = (choice(chains.get(random_key)))
    # print(random_key, random_value_of_random_key)

    while True:
        try:
            new_random_key = (random_key[1], random_value_of_random_key)
            new_random_value_of_new_random_key = choice(chains.get(new_random_key)) # returns a list of values for given key
            
            #print(new_random_key, new_random_value_of_new_random_key)
            
            random_key = new_random_key
            random_value_of_random_key = new_random_value_of_new_random_key

            (words.extend([new_random_key[0], new_random_key[1], new_random_value_of_new_random_key]))
